...
const ViewServiceSaleDetail = ({ isOpen, onClose, order }) => {
  ...
  const ViewOrderCard = ({ children }) => (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl border border-gray-200 relative max-h-[90vh] overflow-y-auto w-full max-w-2xl">
        <button
          onClick={onClose}
  ...
  return (
    <ViewOrderCard>
      <div className="p-6">
        <h2 className="text-xl font-bold text-text-main mb-6">Detalles de la Orden de Servicio</h2>
        
        <div className="space-y-4">
          {/* Información básica */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-text-main mb-1">ID de Orden</label>
