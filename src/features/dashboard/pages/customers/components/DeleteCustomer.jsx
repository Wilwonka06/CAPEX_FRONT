    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-lg shadow-xl border-2 border-red-500 w-full max-w-md p-8 relative animate-fade-in">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl font-bold text-red-600">Eliminar Cliente</h2>
          <p className="text-sm text-gray-600 mt-2">¿Estás seguro de que quieres eliminar este cliente?</p>
        </div>
