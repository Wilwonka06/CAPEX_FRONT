    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                <h2 className="text-xl font-semibold mb-4">Añadir Servicio</h2>
                <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-md mx-auto">
                    <form action="#" method="post" className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="duracion" className="block text-sm font-medium text-text-main mb-1">Duracion (min)</label>
                            <input
                                type="number"
                                name="duracion"
                                id="duracion"
                        ...
                        <div>
                            ...
                            <select
                                name="estado"
                                id="estado"
                                className="w-full border border-primary-dark px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-primary" disabled
                            >
