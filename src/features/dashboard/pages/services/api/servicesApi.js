...
export const createService = async (service) => {
  ...
  try {
    ...
    console.log("[API] POST Service response ->", res.status, res.data);
...
export const updateService = async (id, service) => {
  ...
  try {
    ...
    console.log("[API] PUT Service response ->", res.status, res.data);
...
export const deleteService = async (id) => {
  try {
    ...
    console.log("[API] DELETE Service response ->", res.status, res.data);
    return res.data;
  } catch (err) {
    console.error(
