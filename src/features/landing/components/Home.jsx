  ...
  <main>
    ...
    <section className="relative h-screen flex items-center justify-center">
      ...
      <div className="relative z-20 flex flex-col items-center text-center text-white px-4">
        <h1 className="text-4xl md:text-6xl font-bold mb-4 drop-shadow-lg font-montserrat">CAPEX</h1> {/* Using CAPEX as per Sidebar logo */}
        <p className="text-lg md:text-2xl font-medium max-w-2xl drop-shadow font-lato">Bienvenido a nuestra plataforma. Desarrolla tus habilidades y descubre nuestros productos y servicios.</p>
      </div>
    </section>
